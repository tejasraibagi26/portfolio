...
export default function AboutMeSection () {
    ...
    return(
        <div className="about__me">
            ...
            <h3 className="about__desc__title" >{descTitle}</h3>
            <h4 className = "about__desc ">{desc}</h4>
            <h3 className="about__edu__title " style={{animationDelay: "0.2s"}}>{ed}</h3>
            <h4 className = "about__edu " style={{animationDelay: "0.3s"}}>{ed1}</h4>
            <h4 className = "about__edu2 " style={{animationDelay: "0.4s"}}>{ed2}</h4>
            <h4 className = "about__edu3 " style={{animationDelay: "0.5s"}}>{ed3}</h4>
        </div>
    );
}